...
class SpatieController extends Controller
{
    public function install()
    {
        ...
        if ($user) {
            ...
            \Spatie\Permission\Models\Permission::create(['guard_name' => 'api', 'name' => 'chat/refresh-token', 'title' => 'refresh token']);
            ...
            $teacher_permissions = [
                ...
                'letter/add','letter/update','letter/delete','letter/get','letter/assign','site/user/search-all-users','site/course/teacher','chat/add-room','chat/refresh-token'
            ];
            ...
            'grade/user/course-grade','grade/report/user','site/course/student','chat/add-room','chat/refresh-token'];
