...
class AssignmentController extends Controller
{
    ...
    public function index(Request $request,$count = null)
    {
        ...
        $assignment_lessons = AssignmentLesson::whereIn('lesson_id',$lessons)->with('Assignment.assignmentLesson');
        ...
        foreach($assignment_lessons as $assignment_lesson){
            $assignment=$assignment_lesson->Assignment;
    ...
    public function show($assignment_id,$lesson_id)
    {
        ...
        $assignment = assignment::where('id',$assignment_id)->with('courseItem.courseItemUsers.user')->first();
        if(!isset($assignment))
