    ...
    public function collection()
    {
        ...
        foreach($this->bbb_log as $bbb){
            $bbb_logs->push([
                ...
                'first login' => $bbb['first_login'] == null && $bbb['first_login'] != 0 ? '-' : 'After '.$bbb['first_login']. ' Minute/s',
                'last logout' => $bbb['last_logout'] == null && $bbb['last_logout'] != 0 ? '-' : 'Before '.$bbb['last_logout']. ' Minute/s',
