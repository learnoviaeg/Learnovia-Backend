    ...
    public function store(Request $request)
    {
        ...
        foreach ($array as $item) {
            ...
            foreach ($request->lesson_id as $lesson) {
                ...
                $material=Material::select('id','restricted', 'name','publish_date','course_id','lesson_id')->where('item_id' ,$mediaLesson->media_id)->where('lesson_id' ,$mediaLesson->lesson_id)->where('type' , 'media')->first();
                if(isset($request->users_ids))
                {
                    CoursesHelper::giveUsersAccessToViewCourseItem($media->id, 'media', $request->users_ids);
