...
class Folder extends Model
{
    ...
    {
        return $this->hasMany('Modules\UploadFiles\Entities\FolderLesson');
    }
    ...
    public function courseItem(){
        return $this->hasOne('App\CourseItem', 'item_id')->where('type', 'folder');
    }

    public function lessons()
    {
        return $this->hasManyThrough('App\Lesson' ,'Modules\UploadFiles\Entities\FolderLesson', 'folder_id' , 'id' , 'id' , 'id' );
    }
    public function Lesson()
    {
        return $this->belongsToMany('App\Lesson', 'folder_lessons', 'folder_id', 'lesson_id');
    }
