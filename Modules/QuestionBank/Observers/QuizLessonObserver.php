...
class QuizLessonObserver
{
    ...
    public function created(QuizLesson $quizLesson)
    {
        ...
        // if($quiz->is_graded == 1){
            ...
            $enrolled_students = Enroll::where('role_id' , 3)->whereIn('group',$lesson->shared_classes)
            ...
            $users = Enroll::whereIn('group',$lesson->shared_classes)->where('course',$lesson->course_id)
