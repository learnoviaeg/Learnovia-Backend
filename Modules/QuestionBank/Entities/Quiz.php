...
{
    protected $fillable = ['name','course_id','is_graded','duration','created_by' , 'shuffle','feedback'];
    protected $hidden = [
    ...
    {
        return $this->belongsToMany('App\Questions', 'quiz_questions', 'quiz_id', 'question_id');
    }
