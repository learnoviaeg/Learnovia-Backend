...
Route::group(['prefix' => 'attendance', 'middleware' => 'auth:api'], function () {
    ...
    Route::post('delete-attendance', 'AttendanceController@deleteAttendance')->name('deleteattendence')->middleware('permission:attendance/delete-attendance');
    Route::post('edit-attendance', 'AttendanceController@editAttendance')->name('editattendence')->middleware('permission:attendance/edit-attendence');
    ...
    Route::get('get-sessions', 'AttendanceController@GetAllSessionDay')->name('getsession')->middleware('permission:attendance/get-session');
