...
return [
    ...
    'virtual' => [
        'add' => 'تمت إضافة الحصة الافتراضية بنجاح',
        'update' => 'تم تعديل الحصة الافتراضية بنجاح',
        'delete' => 'تم حذف الحصة الافتراضية بنجاح',
        'list' => 'قائمة الحصص الافتراضية',
        'cannot_join' => 'آسف ، لا يمكنك الانضمام إلى هذه الحصة',
        'join' => 'جاري الانضمام إلى الحصة ...',
        'no_one_entered' => 'لم يدخل أحد هذه الحصة',
        ...
        'attendnace' => [
            'list' => 'قائمة حضور الحصة الافتراضية',
        ],
    ],
];