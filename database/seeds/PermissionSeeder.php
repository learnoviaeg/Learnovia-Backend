...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/mfisg-monthly-2022', 'title' => 'Monthly Report(mfisg)','icon' => 'Report-Card','dashboard'=>1]);
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/mfisg-monthly/oct', 'title' => 'October report','icon' => 'Report-Card']);
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/manara-girls/monthly/printAll-2022', 'title' => 'monthly report print all girls','icon' => 'Report-Card','dashboard'=>1]);
