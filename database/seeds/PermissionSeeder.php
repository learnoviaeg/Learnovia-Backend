...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/mfisb-final', 'title' => 'First term report card (mfisb)', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/mfisg-final', 'title' => 'First term report card (mfisg)', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/manara-boys/printAll-final', 'title' => 'print all boys','icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/manara-girls/printAll-final', 'title' => 'print all girls','icon' => 'Report-Card','dashboard'=>1]);
