...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'grade/user-report', 'title' => 'User Report']);
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfis/mfisg-final', 'title' => 'Final term report card (mfisg)', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfisg/first-term-2022-g', 'title' => 'first term report card 2022/2023(mfisg)', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfisg/first-printAll-2022-g', 'title' => 'first term report card all-2022/2023(mfisg)', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfisb/first-term-2022-b', 'title' => 'first term report card 2022/2023(mfisb)', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/mfisb/first-printAll-2022-b', 'title' => 'first term report card all-2022/2023(mfisb)', 'icon' => 'Report-Card','dashboard'=>1]);
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/gci/first-term', 'title' => 'Fist Term Report (gci)','icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/gci/first-term-all', 'title' => 'First Term Report All(gci)','icon' => 'Report-Card','dashboard'=>1]);
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/fgls/first-term-2022', 'title' => 'First term report card(fgl) 2022/2023', 'icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/fgls/first-term-2022-all', 'title' => 'First term report card All(fgl) 2022/2023', 'icon' => 'Report-Card','dashboard'=>1]);
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'complexity/report', 'title' => 'Complexity report']);
