...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/nile-garden/monthly/oct-2022', 'title' => 'October report 2022','icon' => 'Report-Card','dashboard'=>1]);
        Permission::firstOrCreate(['guard_name' => 'api', 'name' => 'report_card/nile-garden/monthly/oct-2022-all', 'title' => 'October report 2022','icon' => 'Report-Card','dashboard'=>1]);
