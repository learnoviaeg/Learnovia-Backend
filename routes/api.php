...
Route::group(['prefix' => 'year', 'middleware' => 'auth:api'], function () {
    ...
    Route::get('getall', 'AcademicYearController@get')->name('getyear')->middleware('permission:year/get');
...
Route::group(['prefix' => 'course', 'middleware' => 'auth:api'], function () {
    ...
    Route::get('getall', 'CourseController@get')->name('getcourse')->middleware('permission:course/get-all');
    ...
    Route::get('GetUserCourseLessonsSorted' , 'CourseController@GetUserCourseLessonsSorted')->middleware('permission:course/sorted-componenets');
});
...
Route::group(['prefix' => 'enroll' , 'middleware' => 'auth:api'], function () {
    ...
    Route::post('get-unenrolled-users-Bulk', 'EnrollUserToCourseController@unEnrolledUsersBulk')->name('getUnEnrolleduser')->middleware('permission:enroll/get-unenrolled-users-Bulk');
});
